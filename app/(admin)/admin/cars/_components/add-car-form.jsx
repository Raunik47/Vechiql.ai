...
import { Camera, ImagePlus, Loader2, X, Upload, Loader, Loader2Icon } from "lucide-react";
...
import {
  ...
  TabsTrigger,
  TabsContent,
} from "@/components/ui/tabs"; // make sure these components are imported correctly
            ...
            <CardContent>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    Images{" "}
                    {imageError && <span className="text--500">*</span>}
                  </Label>
                  <div className="mt-2">
                    <div
    ...
    <div className="flex flex-wrap gap-2">
      {uploadedImages.map((image, index) => (
        ...
        <TabsContent value="ai" className="mt-6">
          ...
          {/* Add AI-based upload content here */}
        </TabsContent>
      </Tabs>
    </div>
  );
